...
return Config::create()
    ->setEngine(
        $engine = CodeGeneratorEngineFactory::create(
            'https://www.termegest.it/getReserv.asmx?WSDL'
        )
    )
    ->setTypeDestination('src/TermeGestGetReserv/Type')
    ->setTypeNamespace('TermeGestGetReserv\Type')
    ->setClientDestination('src/TermeGestGetReserv')
    ->setClientName('TermeGestGetReservClient')
    ->setClientNamespace('TermeGestGetReserv')
    ->setClassMapDestination('src/TermeGestGetReserv')
    ->setClassMapName('TermeGestGetReservClassmap')
    ->setClassMapNamespace('TermeGestGetReserv')
