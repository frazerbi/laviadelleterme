...
class TermeGestGetReservClassmap
{
    public static function getCollection(): ClassMapCollection
    {
        return new ClassMapCollection(
            ...
            new ClassMap('getDisponibilitaGiornoFascia', Type\GetDisponibilitaGiornoFascia::class),
            new ClassMap('getDisponibilitaGiornoFasciaResponse', Type\GetDisponibilitaGiornoFasciaResponse::class),
            new ClassMap('getDisponibilitaGiornoFasciaResult', Type\GetDisponibilitaGiornoFasciaResult::class),
