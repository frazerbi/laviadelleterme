...
class TermeGestGetReservClassmap
{
    public static function getCollection(): ClassMapCollection
    {
        return new ClassMapCollection(
            ...
            new ClassMap('getDisponibilitaByDay', Type\GetDisponibilitaByDay::class),
            new ClassMap('getDisponibilitaByDayResponse', Type\GetDisponibilitaByDayResponse::class),
            new ClassMap('getDisponibilitaByDayResult', Type\GetDisponibilitaByDayResult::class),
