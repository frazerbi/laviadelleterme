...
class TermeGestGetReservClassmap
{
    public static function getCollection(): ClassMapCollection
    {
        return new ClassMapCollection(
            ...
            new ClassMap('getDisponibilitaByDay', Type\GetDisponibilitaGiornoFascia::class),
            new ClassMap('getDisponibilitaByDayResponse', Type\GetDisponibilitaGiornoFasciaResponse::class),
            new ClassMap('getDisponibilitaByDayResult', Type\GetDisponibilitaGiornoFasciaResult::class),
